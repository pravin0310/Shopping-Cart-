      ...
      <body>  
           ...
           <div class="container" style="width:800px;">  
                ...
                <ul class="nav nav-tabs">  
                     ...
                     <li><a data-toggle="tab" href="#cart"><i class="fa fa-cart-plus">  Cart </i> <span class="badge"><?php if(isset($_SESSION["shopping_cart"])) { echo count($_SESSION["shopping_cart"]); } else { echo '0';}?></span></a></li>  
                </ul>  
                <div class="tab-content">  
                     ...
                     <div class="col-md-4" style="margin-top:12px;">  
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:350px;" align="center">  
                               ...
                               <h4 class="text-danger">$ <?php echo $row["amount"]; ?></h4>  
                               ...
                               <input type="hidden" name="hidden_price" id="price<?php echo $row["id"]; ?>" value="<?php echo $row["amount"]; ?>" />  
